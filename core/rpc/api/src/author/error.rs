		...
		match e {
			...
			Error::Pool(e) => {
				match e.kind() {
					...
					txpool::error::ErrorKind::CycleDetected => rpc::Error {
						code: rpc::ErrorCode::ServerError(POOL_CYCLE_DETECTED),
						message: "Cycle Detected".into(),
						data: None,
					},
					txpool::error::ErrorKind::ImmediatelyDropped => rpc::Error {
...
//			Error::Pool(txpool::error::ErrorKind::InvalidTransaction(e)) => rpc::Error {
//				code: rpc::ErrorCode::ServerError(POOL_INVALID_TX),
//				message: "Invalid Transaction".into(),
//				data: serde_json::to_value(e).ok(),
//			},
